...
`[현재 사실]` 후속 탐색·힌트 게시 PR #20의 기록은 [게시 이력](2026-09-13-github-publication.md#후속-게시-기록-2026-09-15)으로 연결한다. 아래 로컬 검증·후속 게시 대기는 각 단계 작성 시점의 이력이며 설치형·React 이관 완료를 뜻하지 않는다.
