...
현재 구현 범위는 **0~3차 JavaScript 학습 기반과 확장 검증 게이트**입니다. JavaScript 교안 7개, 교안별 기초·적용 객관식 14개, Code Quest 5개를 탐색할 수 있으며 HTML·CSS·Java에는 교안과 객관식 샘플이 각각 1개씩 있습니다. 사이드바에서 네 언어를 전환할 수 있고, 학습 진도와 객관식 결과뿐 아니라 Quest 코드 초안·실행 기록·완료 상태도 새로고침 뒤 유지됩니다. Quest는 브라우저의 공개 테스트를 실제로 실행하고 테스트별 결과, 실패 원인과 단계별 힌트를 제공합니다.
